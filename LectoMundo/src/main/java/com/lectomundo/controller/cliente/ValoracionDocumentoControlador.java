...
public class ValoracionDocumentoControlador {
    ...
    @FXML
    private VBox vboxValoraciones;
    @FXML
    private Button estrella1, estrella2, estrella3, estrella4, estrella5;
    ...
    @FXML
    private void seleccionarEstrella1() {
    ...
    @FXML
    private void seleccionarEstrella2() {
    ...
    @FXML
    private void seleccionarEstrella3() {
    ...
    @FXML
    private void seleccionarEstrella4() {
    ...
    @FXML
    private void seleccionarEstrella5() {
