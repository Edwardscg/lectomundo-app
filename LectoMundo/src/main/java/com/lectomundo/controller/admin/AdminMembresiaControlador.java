...
public class AdminMembresiaControlador {
    ...
    @FXML
    private TableColumn<Membresia, Integer> colIdCliente;
    @FXML
    private TableColumn<Membresia, Date> colFechaInicio;
    @FXML
    private TableColumn<Membresia, Date> colFechaFin;
    @FXML
    private TableColumn<Membresia, Integer> colCosto;
